              ...
              <div className="flex my-5">
                ...
                <div className="ml-auto">
                  {data.join_status ? (
                    <button
                      disabled
                      className="flex items-center bg-red-400 py-1 px-1 md:px-3 rounded text-white"
                    >
                      <img
                        alt="content"
                        className="w-5 h-5 mr-1"
                    ...
                    >
                      <button className="flex items-center bg-green-400 py-1 px-1 md:px-3 rounded text-white">
                        <img
                          alt="content"
                          className="w-5 h-5"
                          src="https://demowebapp.thebattlemania.com/application/views/themes/front/assest/img/coin.png"
